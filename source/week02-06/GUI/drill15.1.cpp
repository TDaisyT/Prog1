//g++ drill15.1.cpp Graph.cpp Window.cpp GUI.cpp Simple_window.cpp -o main `fltk-config --ldflags --use-images`
...
Axis ya {Axis::y, Point{300,500}, 400, 20, "1 == 20 pixels"}; //cross at (300,300)
