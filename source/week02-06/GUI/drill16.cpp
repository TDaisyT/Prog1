...
// actions invoked by callbacks:	
	...
	void stylechange(Line_style l) { lines.set_style(l);}

	void hide_cmenu() { color_menu.hide(); cmenu_button.show(); }
	void hide_smenu() { style_menu.hide(); smenu_button.show(); }

	void red_pressed() { change(Color::red); hide_cmenu();hide_smenu();}
	void blue_pressed() { change(Color::blue); hide_cmenu();hide_smenu();}
	void black_pressed() { change(Color::black); hide_cmenu();hide_smenu();}

	void dash_pressed() { stylechange(Line_style::dash);hide_smenu();hide_cmenu();}
	void solid_pressed() { stylechange(Line_style::solid);hide_smenu();hide_cmenu();}
	void dot_pressed() { stylechange(Line_style::dot);hide_smenu();hide_cmenu();}
	void dashdot_pressed() { stylechange(Line_style::dashdot);hide_smenu();hide_cmenu();}
	void dashdotdot_pressed() { stylechange(Line_style::dashdotdot);hide_smenu();hide_cmenu();}
	
	void cmenu_pressed() { cmenu_button.hide(); smenu_button.hide(); color_menu.show(); }
	void smenu_pressed() { smenu_button.hide(); cmenu_button.hide(); style_menu.show(); }
